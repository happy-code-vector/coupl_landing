  ...
  return (
    <section className="w-full py-12 md:py-16 overflow-hidden">
      <div className="w-full px-4">
        {/* Header Text */}
        <p className="text-center text-pink-900/70 font-rethink-sans text-[14px] md:text-[16px] mb-8">
          Rooted in research from top institutions and loved by couples at:
        </p>
